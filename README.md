...
**[AzureDevOps.WikiPDFExport.exe](https://github.com/BenjaminBrienen/AzureDevOps.WikiPDFExport/releases)*- (~30MB)
...
The download is available [here](https://github.com/BenjaminBrienen/AzureDevOps.WikiPDFExport/releases)
