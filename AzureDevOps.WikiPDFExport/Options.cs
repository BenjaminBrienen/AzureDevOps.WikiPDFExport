...
internal class Options
{
	...
	[Option('i', "input-file", Required = false, HelpText = "Path to a single markdown file that should be converted.")]
	...
	[Option("highlight-style", Required = false, HelpText = "highlight.js style used for code blocks. Defaults to 'vs'. See https://github.com/highlightjs/highlight.js/tree/main/src/styles for a full list.")]
